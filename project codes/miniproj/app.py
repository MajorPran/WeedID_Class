...
import os
import torch
from flask import Flask, request, jsonify, render_template # Framework to handle requests in python
from flask_cors import CORS  # Cross-Origin Resource Sharing
from PIL import Image #Python Imaging in Library
import io 
import pathlib
...
@app.route('/detect', methods=['POST'])  # Weed detection check
def detect_weed():
...
@app.route('/health', methods=['GET']) # Check whether Flask server is operational, whenever we host the server
def health_check():
