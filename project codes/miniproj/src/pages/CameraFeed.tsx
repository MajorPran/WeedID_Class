...
import { ArrowLeft, AlertTriangle, Camera, User, Clock, Calendar, Shield } from 'lucide-react';
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-1/4">
            ...
            <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl shadow-sm border border-purple-200 dark:border-purple-800 p-4">
              <h2 className="text-lg font-medium text-purple-800 dark:text-purple-300 mb-3">Proctor Controls</h2>
